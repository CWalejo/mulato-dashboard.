...
        except Exception as e:
            st.error(f"Error de red: {e}")este es elñ que teniamos, dejalo listo, y pues quita lo de las llaves de gemini dejala lista mientras tanto caso que mañana sea pegarle la cclave de openia y listo y le agregas lo del btablero 
